...
-- SFE_PIPELINE_ROLE: Modify raw and staging data
...
-- BILLING_ANALYST_ROLE: Read analytics layer
GRANT USAGE ON SCHEMA SNOWFLAKE_EXAMPLE.SFE_ANALYTICS_COSTS TO ROLE BILLING_ANALYST_ROLE;
GRANT SELECT ON ALL TABLES IN SCHEMA SNOWFLAKE_EXAMPLE.SFE_ANALYTICS_COSTS TO ROLE BILLING_ANALYST_ROLE;
GRANT SELECT ON FUTURE TABLES IN SCHEMA SNOWFLAKE_EXAMPLE.SFE_ANALYTICS_COSTS TO ROLE BILLING_ANALYST_ROLE;

-- SFE_INTELLIGENCE_ROLE: Read analytics and knowledge base
GRANT USAGE ON SCHEMA SNOWFLAKE_EXAMPLE.SFE_ANALYTICS_COSTS TO ROLE SFE_INTELLIGENCE_ROLE;
GRANT SELECT ON ALL TABLES IN SCHEMA SNOWFLAKE_EXAMPLE.SFE_ANALYTICS_COSTS TO ROLE SFE_INTELLIGENCE_ROLE;
GRANT SELECT ON FUTURE TABLES IN SCHEMA SNOWFLAKE_EXAMPLE.SFE_ANALYTICS_COSTS TO ROLE SFE_INTELLIGENCE_ROLE;
GRANT USAGE ON SCHEMA SNOWFLAKE_EXAMPLE.SFE_SHARED_KNOWLEDGE TO ROLE SFE_INTELLIGENCE_ROLE;
GRANT SELECT ON ALL TABLES IN SCHEMA SNOWFLAKE_EXAMPLE.SFE_SHARED_KNOWLEDGE TO ROLE SFE_INTELLIGENCE_ROLE;
